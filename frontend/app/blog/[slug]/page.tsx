    ...
    <div className="flex min-h-screen flex-col overflow-hidden">
      ...
      <main className="flex-1 w-full overflow-hidden bg-white">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-b from-[#F9F5F0] to-white z-0"></div>
              ...
              <div className="text-center mb-12">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                  ...
                  <div className="flex items-center space-x-4">
                    <button 
                      onClick={toggleBookmark}
                      className="flex items-center text-sm text-[#6B4423] hover:text-[#5A3A1F] transition-colors group"
                    >
                      <Bookmark 
                    ...
                    <div className="relative">
                      <button 
                        ...
                        className="flex items-center text-sm text-[#6B4423] hover:text-[#5A3A1F] transition-colors group relative z-10"
                      >
          ...
          <article className="max-w-3xl mx-auto px-4">
            ...
            <div className="mt-12 p-8 bg-[#F9F5F0] rounded-xl">
              <div className="flex flex-col md:flex-row items-start">
                <div className="relative h-24 w-24 min-w-[6rem] rounded-full overflow-hidden mb-6 md:mb-0 md:mr-8 border-4 border-white shadow-md flex-shrink-0">
                  <Image
                    src={post.authorImage}
                    alt={post.author}
                    width={96}
